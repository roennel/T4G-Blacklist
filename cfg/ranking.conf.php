...
# Initalize Config
$config = new alxApplicationConfig('ranking');
$config->addHost('ranking.tools4games.com');
...
$config->app->host = 'ranking.tools4games.com';
$config->app->port = 80;
$config->app->root = '/';

$config->app->global_view     = 'global_ranking';
